...
const SECTIONS = [
  { title: "1. Service Scope", body: "Asistoria provides configurable business communication agents, call routing workflows, operational dashboards, transcript tools, and related account services." },
  ...
  { title: "8. Contact", body: "legal@asistoria.local" },
];
      ...
      <div style={{ maxWidth: "820px", margin: "0 auto" }}>
        ...
        >
          ...
          <p style={{ color: "#64748b", fontSize: "14px", marginBottom: "32px", lineHeight: 1.6 }}>
            Effective date: 17 April 2026. These terms govern access to Asistoria services for business call handling, voice workflows, and dashboard operations.
          </p>
